...
export const getByName = async (name: string, server: string): Promise<IBadge | null> => {
...
export const checkName = async (name: string, server: string): Promise<boolean> => {
...
export const getAllUserBadges = async (user: string, server: string): Promise<{ _id: string, badges: IBadge[] }[]> => {
...
export const giveBadge = async (badge: IBadge, user: string, server: string): Promise<IUserBadge | null> => {
...
export const checkBadgeUser = async (badge: IBadge, user: string, server: string): Promise<boolean> => {
...
export const deleteBadge = async (badgeName: string, server: string): Promise<IBadge | null> => {
