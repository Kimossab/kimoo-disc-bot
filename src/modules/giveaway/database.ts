...
export const createParticipant = (
  participant: Omit<GiveawayParticipant, "id">
) =>
  prisma.giveawayParticipant.create({
    data: participant,
  });

export const removeParticipant = (id: string) =>
  prisma.giveawayParticipant.delete({
    where: { id },
  });

export const removeWinnerAndDisable = (id: string) =>
  prisma.giveawayParticipant.update({
    where: { id },
    data: {
      isWinner: false,
      canWin: false,
...
export const setWinner = (id: string) =>
  prisma.giveawayParticipant.update({
    where: { id },
    data: { isWinner: true },
  });
