...
export const createParticipant = (participant: Omit<GiveawayParticipant, "id">) => prisma.giveawayParticipant.create({ data: participant });

export const removeParticipant = (id: string) => prisma.giveawayParticipant.delete({ where: { id } });
