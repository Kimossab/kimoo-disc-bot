const messageList = {
  ...
  birthday: {
    ...
    today_bday:
      "Deem todos os parabéns ao aniversariante de hoje:",
    today_bday_s:
      "Deem todos os parabéns aos aniversariantes de hoje:",
    ...
    set_success:
      "Birthday to user <user> set successfully for date <date>",
  ...
  achievements: {
    ...
    create_success:
      "Achievement <name> created successfully",
    update_success:
      "Achievement <name> updated successfully",
    delete_success: "Achievement <id> deleted successfully",
    not_found: "Achievement with id <id> was not found",
    already_got:
      "User <user> already got the achievement <id>",
    given_success:
      "Achievement <name> given to <user> with success",
    ...
    server_no_achievements:
      "Server has no achievements yet",
